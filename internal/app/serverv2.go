...
// get+search; OU-2 adds kb write). It is NOT wired into app.Serve/cli —
// dark until cutover (OU-3), which will add the remaining write tools
// (backlog/roadmap) and swap this in for buildServer.
//

...
// queryCapability is the shesha Capability for the single query read tool
...
func (c queryCapability) Attach(r *shesha.Registrar) error {
	shesha.AddTool(r, &mcpx.Tool{
		Name:        "query",
		Description: descQueryToolV2,
		Annotations: &mcpx.ToolAnnotations{ReadOnlyHint: true},
	}, shesha.ReadOnly, handleQueryV2(c.st))
	return nil
}

// kbCapability is the shesha Capability for the kb write tool (OU-2).
...
func (c kbCapability) Attach(r *shesha.Registrar) error {
	shesha.AddTool(r, &mcpx.Tool{
		Name:        "kb",
		Description: descKBToolV2,
		Annotations: &mcpx.ToolAnnotations{IdempotentHint: true},
	}, shesha.Write, handleKBV2(c.st))
	return nil
}

// backlogCapability is the shesha Capability for the backlog write tool
...
func (c backlogCapability) Attach(r *shesha.Registrar) error {
	shesha.AddTool(r, &mcpx.Tool{
		Name:        "backlog",
		Description: descBacklogToolV2,
		Annotations: &mcpx.ToolAnnotations{DestructiveHint: mcpx.BoolPtr(true)},
	}, shesha.Destructive, handleBacklogV2(c.st))
	return nil
}

// roadmapCapability is the shesha Capability for the roadmap write tool
...
func (c roadmapCapability) Attach(r *shesha.Registrar) error {
	shesha.AddTool(r, &mcpx.Tool{
		Name:        "roadmap",
		Description: descRoadmapToolV2,
		Annotations: &mcpx.ToolAnnotations{DestructiveHint: mcpx.BoolPtr(true)},
	}, shesha.Destructive, handleRoadmapV2(c.st))
	return nil
}

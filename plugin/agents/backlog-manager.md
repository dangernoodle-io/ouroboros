...
2. **Verify project exists** — if `item` returns an error indicating unknown project, fail with: "Project `<name>` not found. Create it first via CLI: `ouroboros project create <name>`"
